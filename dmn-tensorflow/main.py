...
#max size params
flags.DEFINE_integer('max_sent_size', 1, 'default sent size value')
flags.DEFINE_integer('max_ques_size', 1, 'default quesstion size value')
flags.DEFINE_integer('max_fact_count', 1, 'default fact count value')
